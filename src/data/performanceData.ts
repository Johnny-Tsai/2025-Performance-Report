    ...
    workGoals: [
      {
        ...
        metrics: [
          '(7/31) 遷移至 .NET 9、EF Core 9 (DTO、FluentValidation)',
          '(8/31) API改為RESTful API',
          '(12/31) 套用新版面',
          '(12/31) 前端套用 kendo、Vue',
        ],
        achievements: [
          '✅ 7月底完成.NET 9與EF Core 9遷移，引入DTO模式與FluentValidation驗證機制',
          '✅ 8月底將傳統API重構為RESTful API，提升介面一致性與可讀性',
          '⏳ 12月底前完成新版面套用與Kendo、Vue前端框架整合（進行中）',
        ],
        weight: 30,
      },
      {
