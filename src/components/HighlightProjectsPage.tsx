...
interface HighlightProjectsPageProps {
  projects: HighlightProject[];
  onBack: () => void;
}

export function HighlightProjectsPage({ projects, onBack }: HighlightProjectsPageProps) {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-8 mb-8 shadow-lg">
          ...
          <p className="text-emerald-100 mt-3 text-lg">
            2025 年度共完成 <span className="font-bold text-white">{projects.length}</span> 個重點專案，涵蓋品質管理、內控預警、團膳系統等多個領域
          </p>
        </div>
                          ...
                          <div key={idx} className="bg-white rounded-lg overflow-hidden border border-gray-200">
                            ...
                            <div className="p-3">
                              <img
                                ...
                                onClick={() => setLightboxImage({ src: screenshot.image, alt: screenshot.name })}
                              />
